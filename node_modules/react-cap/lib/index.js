...
var updateTags = function updateTags(type, tags) {
    ...
    var tagNodes = headElement.querySelectorAll(type + ":not([" + HELMET_IGNORE_ATTRIBUTE + "])");
...
var Helmet = function Helmet(Component) {
    ...
    return _temp = _class = function (_React$Component) {
        ...
        function HelmetWrapper() {
            ...
            return possibleConstructorReturn(this, (HelmetWrapper.__proto__ || Object.getPrototypeOf(HelmetWrapper)).apply(this, arguments));
        }

        createClass(HelmetWrapper, [{
            ...
            value: function flattenArrayTypeChildren(_ref) {
                ...
                return _extends({}, arrayTypeChildren, defineProperty({}, child.type, [].concat(toConsumableArray(arrayTypeChildren[child.type] || []), [_extends({}, newChildProps, this.mapNestedChildrenToProps(child, nestedChildren))])));
            }
        }, {
            ...
            value: function mapObjectTypeChildren(_ref2) {
                ...
                switch (child.type) {
                    case TAG_NAMES.TITLE:
                        return _extends({}, newProps, (_babelHelpers$extends2 = {}, defineProperty(_babelHelpers$extends2, child.type, nestedChildren), defineProperty(_babelHelpers$extends2, "titleAttributes", _extends({}, newChildProps)), _babelHelpers$extends2));
                ...
                return _extends({}, newProps, defineProperty({}, child.type, _extends({}, newChildProps)));
            }
        }, {
            ...
            value: function mapArrayTypeChildrenToProps(arrayTypeChildren, newProps) {
                ...
                Object.keys(arrayTypeChildren).forEach(function (arrayChildName) {
                    newFlattenedProps = _extends({}, newFlattenedProps, defineProperty({}, arrayChildName, arrayTypeChildren[arrayChildName]));
                });
